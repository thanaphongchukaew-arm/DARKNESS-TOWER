...
(function () {
  var quests = [
    ...
    { id: 'q_floor_20', name: 'นักบุกเบิกแดนอัศวิน', nameEn: "Knight's Ward Explorer", icon: 'doorway', type: 'floor', target: 20,
      desc: 'ไต่หอคอยถึงชั้นที่ 20', descEn: 'Reach floor 20 of the tower.',
      reward: { gold: 350, exp: 150, items: [{ id: 'mat_iron_shard', qty: 4 }] } },
    ...
    { id: 'q_floor_40', name: 'ผู้ฝ่าดงมังกรและปีศาจ', nameEn: 'Dragon and Demon Vanquisher', icon: 'doorway', type: 'floor', target: 40,
      desc: 'ไต่หอคอยถึงชั้นที่ 40', descEn: 'Reach floor 40 of the tower.',
      reward: { gold: 900, exp: 500, items: [{ id: 'mat_dragon_scale', qty: 4 }] } },
    ...
    { id: 'q_floor_60', name: 'ผู้ท่องทะเลทรายกระดูก', nameEn: 'Wanderer of the Bone Desert', icon: 'doorway', type: 'floor', target: 60,
      desc: 'ไต่หอคอยถึงชั้นที่ 60', descEn: 'Reach floor 60 of the tower.',
      reward: { gold: 2000, exp: 1200, items: [{ id: 'mat_bone_fragment', qty: 4 }] } },
    { id: 'q_floor_80', name: 'ผู้ฝ่าห้วงแช่แข็งไร้แสง', nameEn: 'Breaker of the Sunless Frozen Abyss', icon: 'doorway', type: 'floor', target: 80,
      desc: 'ไต่หอคอยถึงชั้นที่ 80', descEn: 'Reach floor 80 of the tower.',
      reward: { gold: 3200, exp: 2000, items: [{ id: 'p_hp_transcendent', qty: 3 }] } },
