...
(function () {
  var items = [
    ...
    { id: 'w_apprentice_wand', name: 'คทาศิษย์เวท', nameEn: 'Apprentice Wand', kind: 'weapon', tier: 1, icon: 'weaponSlotMag', statBonus: { mag: 5 }, desc: '+5 MAG', descEn: '+5 MAG' },
    ...
    { id: 'w_arcane_staff', name: 'คทาอาถรรพ์', nameEn: 'Arcane Staff', kind: 'weapon', tier: 2, icon: 'weaponSlotMag', statBonus: { mag: 9, res: 2 }, desc: '+9 MAG, +2 RES', descEn: '+9 MAG, +2 RES' },
    ...
    { id: 'w_grand_grimoire', name: 'คัมภีร์เวทมนตร์', nameEn: 'Grand Grimoire', kind: 'weapon', tier: 3, icon: 'weaponSlotMag', statBonus: { mag: 14, mp: 6 }, desc: '+14 MAG, +6 MP', descEn: '+14 MAG, +6 MP' },
    ...
    { id: 'w_infernal_scepter', name: 'คทานรกา', nameEn: 'Infernal Scepter', kind: 'weapon', tier: 4, icon: 'weaponSlotMag', statBonus: { mag: 22, mp: 8 }, desc: '+22 MAG, +8 MP', descEn: '+22 MAG, +8 MP' },
    ...
    { id: 'w_archdemon_tome', name: 'คัมภีร์อาร์คเดวิล', nameEn: 'Archdemon Tome', kind: 'weapon', tier: 5, icon: 'weaponSlotMag', statBonus: { mag: 35, mp: 12 }, desc: '+35 MAG, +12 MP', descEn: '+35 MAG, +12 MP' },
    ...
    { id: 'w_choral_staff', name: 'คทาเสียงประสาน', nameEn: 'Choral Staff', kind: 'weapon', tier: 6, icon: 'weaponSlotMag', statBonus: { mag: 48, mp: 16 }, desc: '+48 MAG, +16 MP', descEn: '+48 MAG, +16 MP' },
    ...
    { id: 'w_eternity_tome', name: 'คัมภีร์นิรันดร์', nameEn: 'Tome of Eternity', kind: 'weapon', tier: 7, icon: 'weaponSlotMag', statBonus: { mag: 65, mp: 22 }, desc: '+65 MAG, +22 MP', descEn: '+65 MAG, +22 MP' },
