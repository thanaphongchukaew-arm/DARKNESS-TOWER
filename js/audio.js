...
(function () {
  ...
  var SFX = {
    ...
    hit_weak: function () { playSeq([[NOTES.E5, 0.04, 0.01], [NOTES.G5, 0.04, 0.01], [NOTES.C6, 0.1, 0]], { type: 'square', gain: 0.25 }); },
    ...
    reflect: function () { playSeq([[NOTES.G5, 0.04, 0.01], [NOTES.C5, 0.06, 0]], { type: 'square', gain: 0.2 }); },
